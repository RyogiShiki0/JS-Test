...
// add your code here
let currentDiv = document.getElementById("pictures");
for (let i=0;i<picArray.length;i++){
  let article=document.createElement("article")
  article.setAttribute("class","card")
  article.setAttribute("onclick",`showpic("${picArray[i].image.large}")`)
  ...
  currentDiv.appendChild(article)
}
function showpic(img_url) {
  let dialog = document.querySelector("dialog")
  dialog.querySelector("img").setAttribute("src",img_url)
  dialog.showModal()
}
function close_pic(){
